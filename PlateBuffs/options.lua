...
core.CoreOptionsTable = {
    ...
    args = {
        ...
        saveNameToGUID = {
            ...
            set = function(info, val) P.saveNameToGUID = val end
        },
        watchCombatlog = {
            type = "toggle",
        ...
        addSpellDescriptions = {
            ...
            order = 7,
            get = function() return P.addSpellDescriptions end,
            set = function(info, val)
        ...
        textureSize = {
            ...
            type = "range",
            order = 9,
            min = 0, max = 0.3, step = 0.01, bigStep = 0.1,
            set = function(info, val)
                P.textureSize = val
                core:ResetAllPlateIcons()
            end
        ...
        colorbyType = {
            ...
            set = function(info, val) P.colorByType = val end
        },
        color1 = {
            type = "color",
            name = L["Physical"],
...
core.BarOptionsTable = {
    ...
    args = {
        ...
        barOffsetX = {
            ...
            order = 3,
            min = -256, max = 256, step = 1, bigStep = 10,
            set = function(info, val)
                P.barOffsetX = val
                core:ResetAllBarPoints()
            end
...
core.DefaultSpellOptionsTable = {
    ...
    args = {
        ...
        digitsnumber = {
            ...
            order = 8,
            min = 0, max = 2, step = 1,
            set = function(info, val) P.digitsnumber = val end
        },
        blinkTimeleft = {
            type = "range",
        ...
        showCooldownTexture = {
            ...
            order = 11,
            set = function(info, val) P.showCooldownTexture = val end
        }
    }
}
